...
public class ApprovalInstanceController {
    ...
    public ResponseEntity<ResponseResult<PagedResultDTO<ApprovalInstanceListItemDTO>>> getApprovalInstances(
            ...
            @RequestParam(name = "includeFormData", defaultValue = "false") boolean includeFormData,
            @RequestParam(name = "submissionId", required = false) String submissionId,
            @RequestParam(name = "submitterUserId", required = false) Long submitterUserId,
            @RequestParam(name = "inspectorUserId", required = false) Long inspectorUserId,
            @RequestParam(name = "suggestedProductId", required = false) Long suggestedProductId,
            @RequestParam(name = "suggestedBatchId", required = false) Long suggestedBatchId,
            @RequestParam(name = "teamId", required = false) Long teamId,
            @RequestParam(name = "shiftId", required = false) Long shiftId,
            @RequestParam(name = "formTemplateId", required = false) Long formTemplateId,
            @RequestParam(name = "approvalTemplateId", required = false) String approvalTemplateId,
            @RequestParam(name = "currentRequiredUserId", required = false) String currentRequiredUserId,
            @RequestParam(name = "currentRequiredRoleId", required = false) String currentRequiredRoleId,
            ...
            @RequestParam(name = "formSubmissionState", required = false) String formSubmissionState,
            @RequestParam(name = "isAlarmTriggered", required = false) Boolean isAlarmTriggered
    ) {
        try {
